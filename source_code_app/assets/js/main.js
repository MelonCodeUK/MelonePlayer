...
function musicLegular(wo) {
  if (wo == "next") {
    ...
    $("#music").attr("src", musics[0][musicIndex].substring(7));
    $(".PreviewImg").attr("src", musics[1][musicIndex].substring(7));
    $(".PreviewImg").attr("alt", musics[1][musicIndex].substring(7));
    $("#music")[0].play();
...
$(document).ready(async function () {
  ...
  try {
    ...
    $("#Menu_Buttons_Settings").on("click", function () {
      getI("get.Settings.Window");
    });
  } catch (error) {
